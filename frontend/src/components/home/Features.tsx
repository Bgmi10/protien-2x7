      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 lg:gap-8 text-center text-white">
            <div>
              <div className="text-sm sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2">50,000+</div>
              <div className="text-[8px] sm:text-sm lg:text-base text-blue-100">Happy Customers</div>
            </div>
            <div>
              <div className="text-sm sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2">1M+</div>
              <div className="text-[8px] sm:text-sm lg:text-base text-blue-100">Products Delivered</div>
            </div>
            <div>
              <div className="text-sm sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2">99.8%</div>
              <div className="text-[8px] sm:text-sm lg:text-base text-blue-100">Customer Satisfaction</div>
            </div>
            <div>
              <div className="text-sm sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2">5★</div>
              <div className="text-[8px] sm:text-sm lg:text-base text-blue-100">Average Rating</div>
            </div>
          </div>
        </motion.div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-gray-200 h-full">
                ...
                <h3 className="text-sm sm:text-lg lg:text-xl font-bold text-gray-900 mb-1 sm:mb-1.5 lg:mb-2">
                  {feature.title}
                </h3>
                <p className="text-[10px] sm:text-sm lg:text-base text-gray-600 leading-relaxed">
                  {feature.description}
                </p>
              </div>
            </motion.div>
        ...
        >
          <div className="bg-gray-50 rounded-lg sm:rounded-2xl p-4 sm:p-6 lg:p-8 max-w-xs sm:max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <p className="text-[12px] sm:text-base lg:text-lg text-gray-600 mb-3 sm:mb-5 lg:mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 sm:px-6 sm:py-2.5 lg:px-8 lg:py-3 rounded-lg font-semibold text-[10px] sm:text-sm lg:text-base transition-colors">
                Start Your Journey Today
              </button>
              <button className="text-blue-600 hover:text-blue-700 font-semibold text-[10px] sm:text-sm lg:text-base">
                Talk to Our Experts
              </button>
            </div>
          </div>
