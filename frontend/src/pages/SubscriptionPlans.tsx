              ...
              <div className="grid md:grid-cols-2 h-full">
                ...
                <div className="relative h-32 sm:h-48 md:h-auto">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white p-3 sm:p-4 lg:p-6">
                      ...
                      <p className="text-sm sm:text-sm lg:text-lg opacity-90">{plan.tagline}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-6 lg:p-8 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mb-3 sm:mb-4 lg:mb-6">
                      <div className="flex items-baseline space-x-1 sm:space-x-2 mb-1 sm:mb-2">
                        ...
                        <span className="text-sm sm:text-sm lg:text-base text-gray-500">/month</span>
                      </div>
                      <div className="grid grid-cols-2 gap-1 sm:gap-2 text-xs sm:text-xs lg:text-sm">
                    ...
                    {/* Products Included */}
                    <div className="mb-3 sm:mb-4 lg:mb-6">
                      <h4 className="text-sm sm:text-sm lg:text-base font-semibold text-gray-900 mb-2 sm:mb-3">Products included:</h4>
                      <div className="flex flex-wrap gap-1 sm:gap-2">
                        {plan.products.map((product, i) => (
                          <span key={i} className="bg-gray-100 text-gray-700 px-2 py-0.5 sm:px-2.5 sm:py-1 lg:px-3 lg:py-1 rounded-full text-xs sm:text-xs lg:text-sm">
                            {product}
                          </span>
                        ))}
                      </div>
                  ...
                  <Link
                    ...
                    className={`w-full bg-gradient-to-r ${colorMap[plan.color as keyof typeof colorMap]} text-white py-2 sm:py-3 lg:py-4 rounded-lg sm:rounded-xl font-bold text-sm sm:text-sm lg:text-lg flex items-center justify-center space-x-1 sm:space-x-2 hover:shadow-lg transition-all duration-300 group`}
                  >
